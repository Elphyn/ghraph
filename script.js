...
let oldPlayer = { x: 0, y: 0 };
let targetPos = { x: 0, y: 0 };
let oldtargetPos = { x: 0, y: 0 };
...
function loop() {
	...
	if (oldPlayer != playerPos){
		console.log("green coords: ",playerPos)
	}
	oldPlayer = playerPos;
	if (oldtargetPos != targetPos){
		console.log("blue coords:",targetPos)
	}
